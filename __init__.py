# Lightdesk add-on for Blender 2.8+
# Adds a lighting desk control panel to the 3dView toolbar
# Add lights in the current scene to lighting channels on the desk
# Control the colour, power, and visibiity of lights from the desk
